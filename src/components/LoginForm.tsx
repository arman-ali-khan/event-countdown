...
const LoginForm: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="Sign In - CountdownBuilder"
        description="Sign in to your CountdownBuilder account to manage your countdown events, access your dashboard, and edit your countdown timers."
        keywords="login, sign in, account access, countdown dashboard"
        noIndex={true}
      />
