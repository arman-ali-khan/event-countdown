...
import { Calendar, Clock, Upload, Heart, Gift, Rocket, Sparkles, X, ArrowLeft } from 'lucide-react';
...
const EditEventForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (foundEvent.backgroundImage) {
      setImagePreview(foundEvent.backgroundImage);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let backgroundImageUrl = event?.backgroundImage || '';
