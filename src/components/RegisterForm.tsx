...
const RegisterForm: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="Create Account - CountdownBuilder"
        description="Create a free CountdownBuilder account to manage multiple countdown events, access advanced features, and customize your countdown timers."
        keywords="register, create account, sign up, free account, countdown account"
        noIndex={true}
      />
