...
import { Shield, ShieldOff, Trash2, ChevronLeft, ChevronRight, MoreHorizontal, User, Calendar, Hash } from 'lucide-react';
import { User as UserType, CountdownEvent } from '../../types';
      ...
      <div className="lg:hidden">
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {paginatedUsers.map((user) => {
            const userEvents = events.filter(event => event.userId === user.id);
            return (
              <div key={user.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
