...
const ContactUs: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
      <>
        <SEOHead
          title="Message Sent - Contact CountdownBuilder Support"
          description="Thank you for contacting CountdownBuilder support. We've received your message and will respond within 24 hours."
          noIndex={true}
        />
  ...
  return (
    <>
      <SEOHead
        title="Contact Us - CountdownBuilder Support"
        description="Get in touch with CountdownBuilder support. We're here to help with questions about creating countdown timers, technical issues, and feature requests."
        keywords="contact support, countdown help, technical support, customer service, countdown builder contact"
      />
