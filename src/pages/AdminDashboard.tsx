...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <>
        <SEOHead
          title="Admin Dashboard - CountdownBuilder"
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200 relative whitespace-nowrap ${
                        activeTab === tab.id
