...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="CountdownBuilder - Create Beautiful Countdown Pages for Any Event"
        description="Create stunning countdown timers for weddings, birthdays, product launches, and special events. No coding required. Free countdown page builder with custom backgrounds and social sharing."
        keywords="countdown timer, event countdown, wedding countdown, birthday countdown, product launch countdown, free countdown maker, countdown page builder, event timer"
        ogType="website"
